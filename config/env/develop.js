 ...
 * is only used in your develop environment, i.e. when you lift your app using:
 *
 * ```
 * NODE_ENV=develop node app
 * ```
 *
...
module.exports = {
  ...
  /**************************************************************************
  *                                                                         *
  * Tell Sails what database(s) it should use in develop.                *
  *                                                                         *
  ...
  **************************************************************************/
  datastores: {
    ...
    /***************************************************************************
    *                                                                          *
    * Configure your default develop database.                              *
    *                                                                          *
    * 1. Choose an adapter:                                                    *
  ...
  models: {
    ...
    * strategy to "safe" when your app lifts in develop mode.               *
    ...
    ***************************************************************************/
    ...
    /***************************************************************************
    *                                                                          *
    * If, in develop, this app has access to physical-layer CASCADE         *
  ...
  * > all environments (not just in develop.)                            *
  *                                                                         *
  ***************************************************************************/
  blueprints: {
    shortcuts: false,
  ...
  /***************************************************************************
  *                                                                          *
  * Configure your security settings for develop.                         *
  *                                                                          *
  * IMPORTANT:                                                               *
  ...
  * developed with CSRF protection turned on in development mode too.           *
  *                                                                          *
  ***************************************************************************/
  security: {
    ...
    *                                                                          *
    * > Replace "https://example.com" with the URL of your develop server.  *
  ...
  /***************************************************************************
  *                                                                          *
  * Configure how your app handles sessions in develop.                   *
  *                                                                          *
  * (https://sailsjs.com/config/session)                                     *
  *                                                                          *
  * > If you have disabled the "session" hook, then you can safely remove    *
  * > this section from your `config/env/develop.js` file.                *
  *                                                                          *
  ***************************************************************************/
  session: {
    ...
    /***************************************************************************
    *                                                                          *
    * Develop session store configuration.                                  *
    *                                                                          *
    ...
    ***************************************************************************/
    ...
    /***************************************************************************
    *                                                                          *
    * Develop configuration for the session ID cookie.                      *
    *                                                                          *
    ...
    * > other options, you should always set `secure: true` in develop      *
  ...
  /**************************************************************************
  *                                                                          *
  * Set up Socket.io for your develop environment.                        *
  *                                                                          *
  ...
  ***************************************************************************/
  sockets: {
    ...
    * > (See https://sailsjs.com/config/sockets for the ladevelop version info)   *
    *                                                                          *
  ...
  ***************************************************************************/
  ...
  http: {
    ...
    /***************************************************************************
    *                                                                          *
    * The number of milliseconds to cache static assets in develop.         *
  ...
  *                                                                         *
  * For the safety of your users' data, you should use SSL in develop.   *
  ...
  **************************************************************************/
  ...
  /**************************************************************************
  *                                                                         *
  * Develop overrides for any custom settings specific to your app.      *
  * (for example, develop credentials for 3rd party APIs like Stripe)    *
  *                                                                         *
